...
export default function Header({setNavmenuOtpion,NavmenuOtpion}) {
  const Signup=(e)=>{
    e.preventDefault()
    setNavmenuOtpion({ ...NavmenuOtpion, SignupPop: true });
  }
  const Signin=(e)=>{
    e.preventDefault()
    setNavmenuOtpion({ ...NavmenuOtpion, SigninPop: true });
  }
  return (
    <Container>
<div className='navbar'>
          ...
          <div className="menu">
            <div className="submenu">
              ...
              <a href>Schools</a>
              <a href>Recipes</a>
              <a href={true} onClick={(e)=>{Signup(e)}}>Sign Up /</a>
              <a href onClick={(e)=>{Signin(e)}}>Sign In</a>
            </div>
